...
| solidariteit | IDV_low | Standing-with-the-group; conflict resolved keeping IDV-low placement (group-loyalty register) | samenwerking in MAS_low |
...
| resultaat | MAS_high | Outcome-as-worth is the primary register; quick-result LTO_low reading is secondary; collision resolved by keeping MAS_high placement | kortzichtig in LTO_low |
...
Fix applied post-validation (within-country collision check, 2026-05-11):
resultaat -- dropped from LTO_low -- within-country collision with MAS_high; primary register is achievement/outcome (MAS) so MAS_high placement retained; LTO_low slot replaced by kortzichtig (short-sighted -- short-horizon disposition, clean LTO_low signal, no cross-bag collision)
...
LTO_low: traditie, kortetermijn, gewoonten, kortzichtig, snel, verleden, stabiliteit, onmiddellijk, bewezen, behoudend
...
Words considered, rejected, excluded from all Netherlands bags. Words moved between bags during conflict resolution (autonomie, consensus, pragmatisch, spontaan, solidariteit, samenwerking, informeel, resultaat) are NOT denylisted -- they remain placed in their resolved bag and are documented in Section 2.

gelijkheid -- considered for PDI_low and MAS_low; replaced by inclusief in MAS_low and gelijkwaardig in PDI_low; not retained in any bag
vrijheid -- considered for IDV_high and IND_high; replaced by levensvreugde in IND_high; IDV_high already saturated by autonomie/onafhankelijkheid; not retained in any bag
wij -- pronoun, denylist class (also in global denylist)
nu -- deictic, denylist class (also in global denylist)
open -- polysemous high-frequency, denylist class (also in global denylist)
zelf -- pronoun class
...
resultaat -- MAS-high: result -- outcome as measure of worth; sole placement (within-country collision with LTO_low resolved 2026-05-11 by replacing LTO_low slot with kortzichtig)
...
kortzichtig -- LTO-low: short-sighted -- short-horizon disposition; replaces resultaat per within-country collision resolution 2026-05-11
...
Post-validation change: resultaat retained here as sole placement (LTO_low collision resolved by removing resultaat from LTO_low and substituting kortzichtig)
...
Cross-country root flags: none
Root-proximity flags: gewoonten / traditie -- habit cluster; kept: gewoonten is behavioral habit, traditie is cultural inheritance; distinct register; kortetermijn / kortzichtig -- both share kort- root with distinct registers (kortetermijn = horizon, kortzichtig = disposition); kept
Cross-dimension flag: resultaat originally drafted in both MAS_high and LTO_low; within-country collision check requires unique placement; resolved 2026-05-11 by retaining resultaat in MAS_high and replacing the LTO_low slot with kortzichtig
Post-review change: normatiefheid replaced by behoudend (Geert Hofstede review, 2026-05-11)
Post-validation change: resultaat dropped, kortzichtig added (within-country collision resolution, 2026-05-11)
...
- kortzichtig (LTO_low): replacement for resultaat; confirm natural register and frequency in Dutch cultural prose
