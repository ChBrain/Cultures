# Denmark - Culture Content

**Language(s):** Danish (Dansk)

This folder contains culture content for Denmark: the Danish language (Dansk), the historical arc, the cultural position, the process of hygge, an artifact (Janteloven), a place (Copenhagen), and two personas embodying the culture.
...
|-----------|-------|---------|
| Power Distance (PDI) | 18 | **Low** - Equality valued; hierarchy questioned |
| Individualism (IDV) | 74 | **High** - Personal autonomy and individual rights prioritized |
| Uncertainty Avoidance (UAI) | 23 | **Low** - Comfort with ambiguity and change; flexible |
| Masculinity (MAS) | 16 | **Low** - Cooperation, care, and consensus valued over competition |
| Long-Term Orientation (LTO) | 46 | **Moderate** - Balance between present-moment hygge and long-term institutions |
