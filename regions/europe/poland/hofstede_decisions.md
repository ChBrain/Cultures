...
- **Register spread:** position.md Has (tytuł, starszeństwo, zwierzchnik, podległość, posłuszeństwo, hierarchia, autorytet), position_language.md (protokół, przełożony), position.md Drives (formalność).
...
- **Multi-word entries:** własna-droga (hyphenated compound; treated as single token).
- **Cross-country root flags:** none
- **Root-proximity flags (same country):** indywidualność / niezależność / prywatność cluster is clean. Inicjatywa drifts toward MAS-high (competition) but confirmed IDV-high through self-determination framing in persona_male_tomasz Shadow.
- **Register spread:** position.md (indywidualność, niezależność), position_language.md (prywatność), process_przetrwanie.md Echo (samorealizacja), persona_male_tomasz Shadow (inicjatywa, determinacja), persona_male_tomasz Tell (przedsiębiorczość).
- **Persona-anchor words:** indywidualność, niezależność (position.md); inicjatywa (persona_male_tomasz.md)

### IDV / Low (declared 60)
- **Multi-word entries:** wzajemna-pomoc (hyphenated compound).
- **Cross-country root flags:** none
...
- **Register spread:** position.md (rodzina, solidarność), process_przetrwanie.md Echo (zakorzenienie), position_language.md (przynależność), process_przetrwanie.md Direction (wspólnota).
- **Persona-anchor words:** none (opposing bag)
...
- **Register spread:** place_warsaw.md Offers (ambicja, kariera, sukces, wynik), process_przetrwanie.md Echo (osiągnięcie), place_warsaw.md Withheld (honor).
- **Persona-anchor words:** none (opposing bag)
...
- **Register spread:** process_przetrwanie.md Lever (wytrwałość, ciągłość, strategia, cierpliwość, inwestycja), piece_hejnal.md Load Bearing (wytrwałość), piece_history.md Load Bearing (wytrwałość, inwestycja, ciągłości).
...
- **Register spread:** process_przetrwanie.md Direction (dziedzictwo, korzenie), process_przetrwanie.md Echo (przodkowie, zwyczaj, wiara, ceremonia, pamięć), piece_hejnal.md Load Bearing (tradycja, pamięć).
- **Persona-anchor words:** tradycja, pamięć (piece_hejnal.md)
...
- **Register spread:** place_warsaw.md Offers (przyjemność). After the persona rebuild on this PR, radość / relaks no longer fire in persona_female_malgorzata.md content; previous register-spread claim of malgorzata.md as a fire site is stale. Low count is appropriate for IND=29 declared.
- **Persona-anchor words:** none
...
- **Grammatical case agreement:** Verbs, adjectives, and prepositions require correct case on governed nouns. Scoring depends on nominative bag-word forms; genitive/accusative/instrumental forms do not match bag keywords. Piece_hejnal.md was authored with this in mind: zasada / procedura / porządek / norma all appear in nominative case in their sentences.
